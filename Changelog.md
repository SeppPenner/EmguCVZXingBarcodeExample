...
* **Version 1.0.5.0 (2026-08-11)** : Updated nuget packages, moved to Net 10.0, repaired the build, read the barcode directly from the Emgu image, flattened transparent backgrounds while loading, added a test project.
